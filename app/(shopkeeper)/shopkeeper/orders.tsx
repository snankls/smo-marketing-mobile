...
export default function ShopKeeperOrdersScreen() {
  ...
  const renderItem = ({ item }: { item: Order }) => (
    <TouchableOpacity 
      ...
      onPress={() => {
        router.push({
          pathname: "/(shopkeeper)/shopkeeper/order-details",
          params: {
            id: item.id.toString(),
  ...
  return (
    <ScrollView 
      ...
      refreshControl={
        <RefreshControl refreshing={refreshing} onRefresh={onRefresh} colors={[Colors.shopKeeper.primary]} />
      }
    >
      {/* Header */}
      ...
      <View style={styles.filterContainer}>
        ...
        >
          <Ionicons name="refresh-outline" size={18} color={Colors.shopKeeper.primary} />
        </TouchableOpacity>
      </View>
