    ...
    >
      ...
      <View style={styles.sectionCard}>
        ...
        <View style={styles.infoRow}>
          ...
          <Text style={styles.infoValue}>{profile?.CardCode}</Text>
        </View>
        ...
        <View style={styles.infoRow}>
          <Text style={styles.infoLabel}>Warehouse Code</Text>
          <Text style={styles.infoValue}>{profile?.U_WhCode}</Text>
        </View>
      </View>
      ...
      <View style={styles.sectionCard}>
        ...
        <View style={styles.infoRow}>
          ...
          <Text style={styles.infoValue}>
            {profile?.Currency || "PKR"} {parseFloat(profile?.Balance || "0").toFixed(2)}
          </Text>
        </View>
