  ...
  return (
    ...
    >
      <View style={styles.heroCard}>
        ...
        <Text style={styles.role}>Store Manager, Servo Motor Oil</Text>
      ...
      <View style={styles.sectionCard}>
        ...
        <Text style={styles.sectionSubtitle}>
          Common profile and account tasks for the manager side.
        </Text>

        {quickActions.map((action) => (
          <TouchableOpacity key={action.title} activeOpacity={0.8} style={styles.actionRow}>
            <View style={styles.actionIconWrap}>
              <Ionicons name={action.icon} size={20} color="#C62828" />
            </View>
      ...
      <View style={styles.sectionCard}>
        ...
        <Text style={styles.sectionSubtitle}>
          This week you approved 18 orders and closed 6 stock issues.
        </Text>

        <View style={styles.highlightBox}>
          <Ionicons name="trending-up-outline" size={22} color="#C62828" />
          <View style={styles.highlightTextWrap}>
            <Text style={styles.highlightTitle}>Strong operational rhythm</Text>
            <Text style={styles.highlightSubtitle}>
              Response time to shopkeeper requests is under 2 hours on average.
            </Text>
          </View>
        </View>
      </View>
