  ...
  const handleVerifyAccount = async () => {
    ...
    try {
      ...
      if (response.data.status) {
        setMessage({
          text: response.data.message || "Account verified successfully! Please check your email.",
          type: "success",
        });
        ...
        setMessage({
          text: response.data.message || "Account verification failed",
          type: "error",
        });
      }
    } catch (error: any) {
      setMessage({
        text: error.response?.data?.message || "Unable to verify account. Please try again.",
        type: "error",
      });
    } finally {
      setLoading(false);
